	...
	export const buttonVariants = tv({
		...
		variants: {
			...
			size: {
				...
				icon: 'size-9',
				'icon-xs': "size-6 rounded-[min(var(--radius-md),8px)] in-data-[slot=button-group]:rounded-sm [&_svg:not([class*='size-'])]:size-3",
				'icon-sm': 'size-8 rounded-[min(var(--radius-md),10px)] in-data-[slot=button-group]:rounded-sm',
				'icon-lg': 'size-10',
			},
		},
		defaultVariants: {
