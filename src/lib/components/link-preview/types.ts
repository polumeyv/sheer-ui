import type { ArrowProps, ArrowPropsWithoutHTML } from "$lib/components/_shared/utilities/arrow/types.js";
...
import type { FloatingLayerContentProps } from "$lib/components/_shared/utilities/floating-layer/types.js";
