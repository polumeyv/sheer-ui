...
import type { BitsFocusEvent, BitsPointerEvent, OnChangeFn, RefAttachment, WithRefProps } from '$lib/vendor/types';
...
export class LinkPreviewRootState {
	static create(opts: LinkPreviewRootStateOpts) {
		return setLinkPreviewRootContext(new LinkPreviewRootState(opts));
	}
...
export class LinkPreviewTriggerState {
	static create(opts: LinkPreviewTriggerStateOpts) {
		return new LinkPreviewTriggerState(opts, getLinkPreviewRootContext());
	}
...
export class LinkPreviewContentState {
	static create(opts: LinkPreviewContentStateOpts) {
		return new LinkPreviewContentState(opts, getLinkPreviewRootContext());
	}
