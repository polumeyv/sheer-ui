<script lang="ts">
	...
	import { SelectTriggerState } from "$lib/components/combobox/primitive/select.svelte";
	import type { SelectTriggerProps } from "$lib/components/combobox/primitive/index";
