<script lang="ts">import { untrack } from "svelte";
	...
	import { SelectRootState } from "$lib/components/primitive/combobox/select.svelte";
	import ListboxHiddenInput from "$lib/components/primitive/combobox/components/select-hidden-input.svelte";
	let {
		value = $bindable(),
		onValueChange = (() => {}),
		name = "",
