 ...
 */
function loadSerializedPaneGroupState(autoSaveId: string, storage: PaneGroupStorage): SerializedPaneGroupState | null {
	try {
 ...
 * If the state is not found, returns null.
 */
export function loadPaneGroupState(autoSaveId: string, panesArray: PaneState[], storage: PaneGroupStorage): PaneConfigState | null {
