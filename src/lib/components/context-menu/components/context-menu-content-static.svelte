		...
		mergeProps(
			{
				...
				class:
					'bg-popover text-popover-foreground popup-surface popup-surface-static z-50 max-h-(--bits-context-menu-content-available-height) min-w-32 origin-(--bits-context-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-md border p-1 shadow-md',
