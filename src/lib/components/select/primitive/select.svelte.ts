...
import { Previous, watch } from "$lib/vendor/runed/index.js";
import {
	afterSleep,
	afterTick,
	onDestroyEffect,
...
import type { SelectValueSnippetProps } from "$lib/components/select/primitive/types.js";
...
export class SelectScrollDownButtonState {
	static create(opts: SelectScrollButtonImplStateOpts) {
		return new SelectScrollDownButtonState(
			new SelectScrollButtonImplState(opts, getSelectContentContext())
		);
	}
