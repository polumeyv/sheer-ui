<script lang="ts">
	...
	import type { SelectViewportProps } from "$lib/components/select/primitive/index.js";
	import { SelectViewportState } from "$lib/components/select/primitive/select.svelte.js";
