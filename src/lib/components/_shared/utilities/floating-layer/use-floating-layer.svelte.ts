...
const [getFloatingContentContext, setFloatingContentContext] = createContext<FloatingContentState>();
const [getFloatingTooltipRootContext, setFloatingTooltipRootContext] = createContext<FloatingRootState>();
...
export class FloatingArrowState {
	static create(opts: FloatingArrowStateOpts) {
		return new FloatingArrowState(opts, getFloatingContentContext());
	}
...
export class FloatingAnchorState {
	static create(opts: FloatingAnchorStateOpts, tooltip = false) {
		return tooltip
			? new FloatingAnchorState(opts, getFloatingTooltipRootContext())
			: new FloatingAnchorState(opts, getFloatingRootContext());
	}
