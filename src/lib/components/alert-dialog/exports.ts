...
export { default as Title } from '$lib/components/dialog/components/dialog-title.svelte';
...
export { default as Overlay } from '$lib/components/dialog/components/dialog-overlay.svelte';
export { default as Trigger } from '$lib/components/dialog/components/dialog-trigger.svelte';
export { default as Description } from '$lib/components/dialog/components/dialog-description.svelte';
