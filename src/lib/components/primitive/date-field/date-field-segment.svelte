<script lang="ts">
	...
	import type { DateFieldSegmentProps } from '$lib/components/primitive/date-field/index';
	import { createId } from '$lib/vendor/create-id';

	const uid = $props.id();

	let { id = createId(uid), ref = $bindable(null), children, child, part, ...restProps }: DateFieldSegmentProps = $props();
