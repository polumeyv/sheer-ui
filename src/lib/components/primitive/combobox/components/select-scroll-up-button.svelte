<script lang="ts">
	...
	import type { SelectScrollUpButtonProps } from "$lib/components/primitive/combobox/index";
	import { SelectScrollUpButtonState } from "$lib/components/primitive/combobox/select.svelte";
