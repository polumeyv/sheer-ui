<script lang="ts">
	...
	import { CalendarDayState } from "$lib/components/primitive/calendar/calendar.svelte";
	import type { CalendarDayProps } from "$lib/components/primitive/calendar/index";
