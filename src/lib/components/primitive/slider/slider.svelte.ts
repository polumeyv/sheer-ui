...
import { attachRef, type WritableProp, type ReadableProp, DOMContext, type ReadableProps, type WritableProps } from '$lib/vendor/index';
...
import {
	...
	getTickLabelStyles,
	getThumbLabelStyles,
} from '$lib/components/primitive/slider/helpers';
import { createBitsAttrs } from '$lib/vendor/attrs';
import { kbd } from '$lib/vendor/kbd';
import { isValidIndex } from '$lib/vendor/arrays';
import { attachResize, type ResizeAttachment } from '$lib/vendor/svelte-resize-observer.svelte';
...
import type { SliderLabelPosition } from '$lib/components/primitive/slider/index';
...
abstract class SliderBaseRootState {
	...
	readonly resizeAttachment: ResizeAttachment;
	...
	constructor(opts: SliderBaseRootStateOpts) {
		...
		this.resizeAttachment = attachResize(() => {
...
export class SliderRangeState {
	static create(opts: SliderRangeStateOpts) {
		return new SliderRangeState(opts, getSliderRootContext());
	}
...
export class SliderThumbState {
	static create(opts: SliderThumbStateOpts) {
		return new SliderThumbState(opts, getSliderRootContext());
	}
...
export class SliderTickState {
	static create(opts: SliderTickStateOpts) {
		return new SliderTickState(opts, getSliderRootContext());
	}
...
export class SliderTickLabelState {
	static create(opts: SliderTickLabelStateOpts) {
		return new SliderTickLabelState(opts, getSliderRootContext());
	}
...
export class SliderThumbLabelState {
	static create(opts: SliderThumbLabelStateOpts) {
		return new SliderThumbLabelState(opts, getSliderRootContext());
	}
