<script lang="ts">
	...
	import type { RatingGroupRootProps } from "$lib/components/primitive/rating-group/index";
	import { RatingGroupRootState } from "$lib/components/primitive/rating-group/rating-group.svelte";
	import RatingGroupInput from "$lib/components/primitive/rating-group/components/rating-group-input.svelte";
