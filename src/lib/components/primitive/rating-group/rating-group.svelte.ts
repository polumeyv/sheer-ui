...
import type { RatingGroupAriaValuetext, RatingGroupItemState as RatingGroupItemStateType } from '$lib/components/primitive/rating-group/index';
...
export class RatingGroupRootState {
	static create(opts: RatingGroupRootStateOpts) {
		return setRatingGroupRootContext(new RatingGroupRootState(opts));
	}
...
export class RatingGroupItemState {
	static create(opts: RatingGroupItemStateOpts) {
		return new RatingGroupItemState(opts, getRatingGroupRootContext());
	}
...
export class RatingGroupHiddenInputState {
	static create() {
		return new RatingGroupHiddenInputState(getRatingGroupRootContext());
	}
	readonly root: RatingGroupRootState;
