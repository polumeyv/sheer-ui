export { default as Root } from "$lib/components/primitive/context-menu/components/context-menu.svelte";
...
export { default as Content } from "$lib/components/primitive/context-menu/components/context-menu-content.svelte";
export { default as ContentStatic } from "$lib/components/primitive/context-menu/components/context-menu-content-static.svelte";
export { default as Trigger } from "$lib/components/primitive/context-menu/components/context-menu-trigger.svelte";
...
} from "$lib/components/primitive/context-menu/index";
