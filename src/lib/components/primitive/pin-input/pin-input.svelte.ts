...
import { usePasswordManagerBadge } from '$lib/components/primitive/pin-input/usePasswordManager.svelte';
import type { PinInputCell, PinInputRootProps as RootComponentProps } from '$lib/components/primitive/pin-input/index';
...
export class PinInputRootState {
	...
	constructor(opts: PinInputRootStateOpts) {
		...
		onMount(() => {
			...
			this.#prevInputMetadata.prev = [input.selectionStart, input.selectionEnd, input.selectionDirection ?? 'none'];
