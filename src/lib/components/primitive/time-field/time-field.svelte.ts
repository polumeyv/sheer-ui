...
import type { TimeRangeFieldRootState } from '$lib/components/primitive/time-range-field/time-range-field.svelte';
...
const [getTimeFieldRootContext, setTimeFieldRootContext] = createContext<TimeFieldRootState>();
...
export class TimeFieldInputState {
	static create(opts: TimeFieldInputStateOpts) {
		return new TimeFieldInputState(opts, getTimeFieldRootContext());
	}
...
export class TimeFieldHiddenInputState {
	static create() {
		return new TimeFieldHiddenInputState(getTimeFieldRootContext());
	}
	readonly root: TimeFieldRootState;
...
export class TimeFieldLabelState {
	static create(opts: TimeFieldLabelStateOpts) {
		return new TimeFieldLabelState(opts, getTimeFieldRootContext());
	}
