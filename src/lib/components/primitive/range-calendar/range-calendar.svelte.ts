...
import { getCalendarRootContext, setCalendarRootContext } from '$lib/components/primitive/calendar/calendar.svelte';
import type { DateRange, Month } from '$lib/shared/index';
import type { BitsFocusEvent, BitsKeyboardEvent, BitsMouseEvent, RefAttachment, WithRefProps } from '$lib/vendor/types';
...
import { areAllDaysBetweenValid, getDateValueType, isAfter, isBefore, isBetweenInclusive, toDate } from '$lib/vendor/date-time/utils';
...
export class RangeCalendarRootState {
	static create(opts: RangeCalendarRootStateOpts) {
		return setCalendarRootContext(new RangeCalendarRootState(opts));
	}
...
export class RangeCalendarCellState {
	static create(opts: RangeCalendarCellStateOpts) {
		return setRangeCalendarCellContext(new RangeCalendarCellState(opts, getCalendarRootContext() as RangeCalendarRootState));
	}
...
export class RangeCalendarDayState {
	static create(opts: RangeCalendarDayStateOpts) {
		return new RangeCalendarDayState(opts, getRangeCalendarCellContext());
	}
