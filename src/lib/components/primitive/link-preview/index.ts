...
import type { BitsPrimitiveAnchorAttributes, BitsPrimitiveDivAttributes } from '$lib/shared/attributes';
...
export * as LinkPreview from '$lib/components/primitive/link-preview/exports';
