export { default as Root } from "$lib/components/primitive/menubar/components/menubar.svelte";
export { default as Menu } from "$lib/components/primitive/menubar/components/menubar-menu.svelte";
export { default as Content } from "$lib/components/primitive/menubar/components/menubar-content.svelte";
export { default as ContentStatic } from "$lib/components/primitive/menubar/components/menubar-content-static.svelte";
export { default as Trigger } from "$lib/components/primitive/menubar/components/menubar-trigger.svelte";
...
} from "$lib/components/primitive/menubar/index";
