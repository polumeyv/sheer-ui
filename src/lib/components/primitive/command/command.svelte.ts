...
import { findNextSibling, findPreviousSibling } from '$lib/components/primitive/command/utils';
import type { CommandState } from '$lib/components/primitive/command/index';
...
export class CommandRootState {
	static create(opts: CommandRootStateOpts) {
		return setCommandRootContext(new CommandRootState(opts));
	}
...
export class CommandEmptyState {
	static create(opts: CommandEmptyStateOpts) {
		return new CommandEmptyState(opts, getCommandRootContext());
	}
...
export class CommandGroupHeadingState {
	static create(opts: CommandGroupHeadingStateOpts) {
		return new CommandGroupHeadingState(opts, getCommandGroupContainerContext());
	}
...
export class CommandGroupItemsState {
	static create(opts: CommandGroupItemsStateOpts) {
		return new CommandGroupItemsState(opts, getCommandGroupContainerContext());
	}
...
export class CommandInputState {
	static create(opts: CommandInputStateOpts) {
		return new CommandInputState(opts, getCommandRootContext());
	}
...
export class CommandItemState {
	...
	constructor(opts: CommandItemStateOpts, root: CommandRootState) {
		this.opts = opts;
		this.root = root;
		this.#group = getCommandGroupContainerContextOr(null);
...
export class CommandSeparatorState {
	static create(opts: CommandSeparatorStateOpts) {
		return new CommandSeparatorState(opts, getCommandRootContext());
	}
...
export class CommandListState {
	static create(opts: CommandListStateOpts) {
		return setCommandListContext(new CommandListState(opts, getCommandRootContext()));
	}
...
export class CommandLabelState {
	static create(opts: CommandLabelStateOpts) {
		return new CommandLabelState(opts, getCommandRootContext());
	}
...
export class CommandViewportState {
	static create(opts: CommandViewportStateOpts) {
		return new CommandViewportState(opts, getCommandListContext());
	}
