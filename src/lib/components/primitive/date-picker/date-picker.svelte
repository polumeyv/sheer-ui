<script lang="ts">
	...
	import type { DatePickerRootProps } from '$lib/components/primitive/date-picker/index';
	import { PopoverRootState } from '$lib/components/primitive/popover/popover.svelte';
	import { DateFieldRootState } from '$lib/components/primitive/date-field/date-field.svelte.js';
