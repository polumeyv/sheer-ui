...
export { default as Content } from "$lib/components/primitive/dropdown-menu/components/dropdown-menu-content.svelte";
export { default as ContentStatic } from "$lib/components/primitive/dropdown-menu/components/dropdown-menu-content-static.svelte";
...
} from "$lib/components/primitive/dropdown-menu/index";
