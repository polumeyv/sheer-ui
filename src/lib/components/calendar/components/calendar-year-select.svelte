<script lang="ts">
	...
	import type { CalendarYearSelectProps } from "$lib/components/calendar/types.js";
	import { CalendarYearSelectState } from "$lib/components/calendar/calendar.svelte.js";
