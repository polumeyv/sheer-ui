<script lang="ts">
	import type { NavigationMenuViewportProps } from '$lib/components/primitive/navigation-menu/index';
	import { NavigationMenuViewportState } from '$lib/components/primitive/navigation-menu/navigation-menu.svelte';
