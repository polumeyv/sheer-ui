<script lang="ts">
	...
	import type { NavigationMenuListProps } from '$lib/components/primitive/navigation-menu/index';
	import { NavigationMenuListState } from '$lib/components/primitive/navigation-menu/navigation-menu.svelte';
