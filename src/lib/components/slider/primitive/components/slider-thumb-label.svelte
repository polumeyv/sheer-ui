<script lang="ts">
	...
	import type { SliderThumbLabelProps } from "$lib/components/slider/primitive/index";
	import { getSliderRootContext, SliderThumbLabelState } from "$lib/components/slider/primitive/slider.svelte";
