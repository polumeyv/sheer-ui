<script lang="ts">
	...
	import type { DatePickerContentProps } from "$lib/components/date-picker/types.js";
	import PopoverContent from "$lib/components/popover/primitive/components/popover-content.svelte";
