<script lang="ts">
	...
	import type { DatePickerContentStaticProps } from "$lib/components/date-picker/index.js";
	import PopoverContentStatic from "$lib/components/popover/primitive/components/popover-content-static.svelte";
