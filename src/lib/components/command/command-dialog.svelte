...
<!-- Native <dialog> Dialog.Content promotes itself to the top layer, so the old Portal + Overlay
     wrappers are gone (::backdrop dims). `portalProps` stays in the signature for API stability. -->
