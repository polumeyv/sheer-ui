<script lang="ts">
	...
	import type { DrawerOverlayProps as OverlayProps } from '../../internal/vaul/types.js';
		...
		mergeProps(
			{
				...
				class: join('fixed inset-0 z-50 bg-black/50 transition-opacity data-closed:opacity-0', className),
			},
			restProps,
			{
				id,
