 ...
 * timing is the fragile part, so — mirroring the `SettleRunner` seam in
 * `animations-settled.svelte.ts` — the timers are funnelled through this small contract. The default
