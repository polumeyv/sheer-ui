...
import type { Box, ReadableBoxedValues, WritableBoxedValues, RefAttachment as InternalRefAttachment } from './tools/index.js';
import type { StyleProperties } from './tools/types.js';
