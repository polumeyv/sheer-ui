<script lang="ts">
	...
	import { formatTimeDisplay, generateTimeSlots, isTimeInRange, compareTime, getTimeDuration, formatDuration, type TimeSlot, type TimeRange, b_HOURS, EXTENDED_HOURS } from '@polumeyv/lib/booking/utils';
