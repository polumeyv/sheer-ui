...
import SelectValueRepairFixture from "./select-value-repair.fixture.svelte";
...
function renderFixture(props: FixtureProps) {
	...
	const component = mount(SelectValueRepairFixture, { props, target });
	flushSync();
...
describe("Select controlled value repair", () => {
